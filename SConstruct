...
sources = Glob(plugin + '/*.cpp')
sources.append(Glob(plugin + '/*.mm'))
sources.append(Glob(plugin + '/*.m'))

env.Append(CXXFLAGS=['-F', plugin])
env.Append(LINKFLAGS = ['-framework', plugin+'/AdjustSdk.framework'])
